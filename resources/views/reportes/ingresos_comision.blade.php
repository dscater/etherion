...
<body>
    ...
    <div class="encabezado">
        ...
        <h4 class="texto">INGRESOS POR COMISIÓN</h4>
        ...
        <tbody>
            ...
            @foreach ($orden_detalles as $od)
                ...
                <tr>
                    ...
                    <td class="centreado">{{ number_format($comision, 2, '.', '') }}</td>
            ...
            <tr>
                ...
                <td class="bold centreado text-md">{{ number_format($suma_comision, 2, '.', '') }}</td>
                <td></td>
            </tr>
        </tbody>
    </table>
